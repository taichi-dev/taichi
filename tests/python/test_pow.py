...
@test_utils.test(require=ti.extension.data64)
def test_pow_int_base_int_exp_64():
    _test_pow_int_base_int_exp(ti.i32, ti.i64)
    _test_pow_int_base_int_exp(ti.i64, ti.i64)
    _test_pow_int_base_int_exp(ti.i64, ti.i32)
...
@test_utils.test(require=ti.extension.data64)
def test_pow_float_base_int_exp_64():
    _test_pow_float_base_int_exp(ti.f64, ti.i32)
    _test_pow_float_base_int_exp(ti.f32, ti.i64)
    _test_pow_float_base_int_exp(ti.f64, ti.i64)
