...
PER_AMDGPU_FUNCTION(launch_kernel, hipModuleLaunchKernel, void *, uint32, uint32, uint32,
                    uint32, uint32, uint32, uint32, void *, void **, void **);
PER_AMDGPU_FUNCTION(kernel_get_attribute, hipFuncGetAttribute, int *, uint32, void *);
PER_AMDGPU_FUNCTION(kernel_get_occupancy, hipOccupancyMaxActiveBlocksPerMultiprocessor,
                    int *, void *, int, size_t);
