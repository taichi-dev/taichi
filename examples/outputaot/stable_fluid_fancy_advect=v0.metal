...
void mtl_k0004_advect_c4_0_0_func(
  ...
  if (tmp18) {
    ...
    S9 tmp1608 = tmp1607.get2(runtime_, mem_alloc_);
    ...
    S9_ch tmp1612 = tmp1608.children(tmp1978);
    ...
    S9_ch tmp1636 = tmp1608.children(tmp1994);
    ...
    S9_ch tmp1660 = tmp1608.children(tmp2010);
    ...
    S9_ch tmp1684 = tmp1608.children(tmp2026);
    ...
    S9_ch tmp1708 = tmp1608.children(tmp2042);
    ...
    S9_ch tmp1732 = tmp1608.children(tmp2058);
    ...
    S9_ch tmp1756 = tmp1608.children(tmp2074);
    ...
    S9_ch tmp1780 = tmp1608.children(tmp2090);
    ...
    S12 tmp1800 = tmp1607.get3(runtime_, mem_alloc_);
    const int32_t tmp2136 = (tmp1822 << tmp1819);
    const int32_t tmp2106 = (tmp1826 + tmp2136);
    S12_ch tmp1804 = tmp1800.children(tmp2106);
