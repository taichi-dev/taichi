...
const llvm::StringRef ShaderAttrKindStr = "dx.shader";
...
void set_num_threads(llvm::Function *F, unsigned x, unsigned y, unsigned z) {
  const llvm::StringRef NumThreadsAttrKindStr = "dx.numthreads";
  std::string Str =
...
GlobalVariable *createGlobalVariableForResource(Module &M,
  ...
  auto *GV = new GlobalVariable(
      M, Ty, /*isConstant*/ false, GlobalValue::LinkageTypes::ExternalLinkage,
