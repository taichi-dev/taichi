...
user_api[ti.math] = [
    ...
    'mat2', 'mat3', 'mat4', 'max', 'min', 'mix', 'mod', 'translate', 'scale', 'nan', 'normalize',
    'pi', 'pow', 'radians', 'reflect', 'refract', 'rot2', 'rot3', 'rotate2d',
    'rotate3d',"rot3d_by_axis", "rot3d_yaw_pitch_roll", "rotation3d", 'round', 
    'sign', 'sin', 'smoothstep', 'sqrt', 'step', 'tan',
