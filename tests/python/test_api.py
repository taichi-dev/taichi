...
user_api[ti.math] = [
    "clamp", "cross", "degrees", "distance", "dot", "e", "fract", "log2", "mix",
    "normalize", "pi", "radians", "reflect", "refract", "sign", "smoothstep", "step"
]
user_api[ti.Matrix] = [
