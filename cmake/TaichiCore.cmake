...
if (TI_WITH_OPENGL)
  ...
  if (GLEW_FOUND)
    ...
    message("Using GLEW: /usr/lib")
    set(GLEW_LIBRARY_DIR "/usr/lib")
    target_link_libraries(${LIBRARY_NAME} ${GLEW_LIBRARY_DIR}/libGLEW.so GLEW)
    target_link_libraries(${LIBRARY_NAME} ${GLEW_LIBRARY_DIR}/libglfw.so glfw)
  else()
