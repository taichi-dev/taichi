...
TEST(Type, TypeToString) {
  ...
  auto bs1 = TypeFactory::get_instance().get_bit_struct_type(
      /*physical_type=*/u16, /*member_types=*/{qi5, qu7}, /*member_bit_offsets=*/{0, 5}, /*member_exponents=*/{-1, -1}, /*member_exponent_users=*/{{}, {}});
  EXPECT_EQ(bs1->to_string(), "bs(0: qi5@0, 1: qu7@5)");

  auto bs2 = TypeFactory::get_instance().get_bit_struct_type(
      /*physical_type=*/u32, /*member_types=*/{qu7, qfl, qu7, qfl}, /*member_bit_offsets=*/{0, 7, 12, 19}, /*member_exponents=*/{-1, 0, -1, 2},
  ...
  auto bs3 = TypeFactory::get_instance().get_bit_struct_type(
      /*physical_type=*/u32, /*member_types=*/{qu7, qfl, qfl}, /*member_bit_offsets=*/{0, 7, 12}, /*member_exponents=*/{-1, 0, 0}, /*member_exponent_users=*/{{1, 2}, {}, {}});
