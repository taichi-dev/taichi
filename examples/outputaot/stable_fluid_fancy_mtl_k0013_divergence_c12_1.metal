...
void mtl_k0013_divergence_c12_1_0_func(
  ...
  constexpr int32_t tmp12942 = -1;
  constexpr int32_t tmp12932 = 1023;
  constexpr int32_t tmp12928 = 511;
  ...
  constexpr int32_t tmp12870 = 10;
  const int32_t tmp12871 = (tmp3 >> tmp12870);
  const int32_t tmp12873 = (tmp12871 & tmp12928);
  const int32_t tmp12877 = (tmp3 & tmp12932);
  constexpr int32_t tmp13 = 417;
  const int32_t tmp14 = -(tmp12873 < tmp13);
  constexpr int32_t tmp16 = 597;
  const int32_t tmp17 = -(tmp12877 < tmp16);
  const int32_t tmp18 = (tmp14 & tmp17);
  if (tmp18) {
    const int32_t tmp12935 = (tmp12873 + tmp12942);
    const int32_t tmp23 =  min(tmp22, tmp12935);
    const int32_t tmp25 =  max(tmp24, tmp23);
    const int32_t tmp27 =  min(tmp26, tmp12877);
    const int32_t tmp28 =  max(tmp24, tmp27);
    float tmp29(0);
    S0 tmp12788(root_addr);
    S0_ch tmp12790 = tmp12788.children(tmp24);
    S14 tmp12791 = tmp12790.get3(runtime_, mem_alloc_);
    const int32_t tmp12881 = (tmp25 & tmp12928);
    const int32_t tmp12885 = (tmp28 & tmp12932);
    const int32_t tmp13009 = (tmp12881 << tmp12870);
    const int32_t tmp12953 = (tmp12885 + tmp13009);
    S14_ch tmp12795 = tmp12791.children(tmp12953);
    device float* tmp12796 = tmp12795.get0(runtime_, mem_alloc_).val;
    const auto tmp31 = *tmp12796;
    tmp29 = tmp31;
    const int32_t tmp12937 = (tmp12873 + tmp20);
    const int32_t tmp34 =  min(tmp22, tmp12937);
    const int32_t tmp35 =  max(tmp24, tmp34);
    float tmp36(0);
    const int32_t tmp12889 = (tmp35 & tmp12928);
    const int32_t tmp13011 = (tmp12889 << tmp12870);
    const int32_t tmp12961 = (tmp12885 + tmp13011);
    S14_ch tmp12807 = tmp12791.children(tmp12961);
    device float* tmp12808 = tmp12807.get0(runtime_, mem_alloc_).val;
    const auto tmp38 = *tmp12808;
    tmp36 = tmp38;
    const int32_t tmp12939 = (tmp12877 + tmp12942);
    const int32_t tmp41 =  min(tmp22, tmp12873);
    const int32_t tmp42 =  max(tmp24, tmp41);
    const int32_t tmp43 =  min(tmp26, tmp12939);
    const int32_t tmp44 =  max(tmp24, tmp43);
    float tmp45(0);
    const int32_t tmp12897 = (tmp42 & tmp12928);
    const int32_t tmp12901 = (tmp44 & tmp12932);
    const int32_t tmp13013 = (tmp12897 << tmp12870);
    const int32_t tmp12969 = (tmp12901 + tmp13013);
    S14_ch tmp12819 = tmp12791.children(tmp12969);
    device float* tmp12820 = tmp12819.get1(runtime_, mem_alloc_).val;
    const auto tmp47 = *tmp12820;
    tmp45 = tmp47;
    const int32_t tmp12941 = (tmp12877 + tmp20);
    const int32_t tmp50 =  min(tmp26, tmp12941);
    const int32_t tmp51 =  max(tmp24, tmp50);
    float tmp52(0);
    const int32_t tmp12909 = (tmp51 & tmp12932);
    const int32_t tmp12977 = (tmp12909 + tmp13013);
    S14_ch tmp12831 = tmp12791.children(tmp12977);
    device float* tmp12832 = tmp12831.get1(runtime_, mem_alloc_).val;
    const auto tmp54 = *tmp12832;
    tmp52 = tmp54;
    const int32_t tmp12985 = (tmp12885 + tmp13013);
    S14_ch tmp12843 = tmp12791.children(tmp12985);
    device float* tmp12844 = tmp12843.get0(runtime_, mem_alloc_).val;
    const auto tmp57 = *tmp12844;
    device float* tmp12856 = tmp12843.get1(runtime_, mem_alloc_).val;
    const auto tmp59 = *tmp12856;
    const int32_t tmp60 = -(tmp12873 == tmp24);
    ...
    const int32_t tmp65 = -(tmp12873 == tmp22);
    ...
    const int32_t tmp70 = -(tmp12877 == tmp24);
    ...
    const int32_t tmp75 = -(tmp12877 == tmp26);
    ...
    S17 tmp12863 = tmp12790.get4(runtime_, mem_alloc_);
    const int32_t tmp13015 = (tmp12873 << tmp12870);
    const int32_t tmp13001 = (tmp12877 + tmp13015);
    S17_ch tmp12867 = tmp12863.children(tmp13001);
    device float* tmp12868 = tmp12867.get0(runtime_, mem_alloc_).val;
    *tmp12868 = tmp88;
  } else {
  }
}
