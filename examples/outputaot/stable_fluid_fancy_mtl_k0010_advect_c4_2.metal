...
class mtl_k0010_advect_c4_2_args {
 public:
  explicit mtl_k0010_advect_c4_2_args(device byte* addr) : addr_(addr) {}
  device float* arg0() {
    // scalar, size=4 B
...
void mtl_k0010_advect_c4_2_0_func(
  ...
  mtl_k0010_advect_c4_2_args kernel_ctx_(ctx_addr);
  ...
  constexpr int32_t tmp7425 = 10;
  constexpr int32_t tmp7193 = 4095;
  constexpr int32_t tmp7189 = 2047;
  constexpr float tmp97 = 0.0069849244;
  constexpr float tmp94 = 0.01;
  constexpr int32_t tmp7033 = 1023;
  constexpr int32_t tmp7029 = 511;
  ...
  constexpr int32_t tmp6963 = 12;
  const int32_t tmp6964 = (tmp3 >> tmp6963);
  const int32_t tmp6966 = (tmp6964 & tmp7189);
  const int32_t tmp6970 = (tmp3 & tmp7193);
  constexpr int32_t tmp13 = 1668;
  const int32_t tmp14 = -(tmp6966 < tmp13);
  constexpr int32_t tmp16 = 2388;
  const int32_t tmp17 = -(tmp6970 < tmp16);
  const int32_t tmp18 = (tmp14 & tmp17);
  if (tmp18) {
    const int32_t tmp20 = *kernel_ctx_.arg1();
    const int32_t tmp21 = *kernel_ctx_.arg2();
    const float tmp22 = static_cast<float>(tmp6966);
    const float tmp24 = (tmp22 + tmp23);
    const float tmp25 = static_cast<float>(tmp6970);
    ...
    S0 tmp6629(root_addr);
    S0_ch tmp6631 = tmp6629.children(tmp48);
    S11 tmp6632 = tmp6631.get2(runtime_, mem_alloc_);
    const int32_t tmp6974 = (tmp49 & tmp7029);
    const int32_t tmp6978 = (tmp52 & tmp7033);
    const int32_t tmp7426 = (tmp6974 << tmp7425);
    const int32_t tmp7202 = (tmp6978 + tmp7426);
    S11_ch tmp6636 = tmp6632.children(tmp7202);
    device float* tmp6637 = tmp6636.get0(runtime_, mem_alloc_).val;
    const auto tmp54 = *tmp6637;
    device float* tmp6649 = tmp6636.get1(runtime_, mem_alloc_).val;
    const auto tmp56 = *tmp6649;
    const int32_t tmp58 = (tmp40 + tmp57);
    const int32_t tmp59 =  min(tmp46, tmp58);
    const int32_t tmp60 =  max(tmp48, tmp59);
    const int32_t tmp6990 = (tmp60 & tmp7029);
    const int32_t tmp7428 = (tmp6990 << tmp7425);
    const int32_t tmp7218 = (tmp6978 + tmp7428);
    S11_ch tmp6660 = tmp6632.children(tmp7218);
    device float* tmp6661 = tmp6660.get0(runtime_, mem_alloc_).val;
    const auto tmp62 = *tmp6661;
    device float* tmp6673 = tmp6660.get1(runtime_, mem_alloc_).val;
    const auto tmp64 = *tmp6673;
    const int32_t tmp65 = (tmp41 + tmp57);
    const int32_t tmp66 =  min(tmp50, tmp65);
    const int32_t tmp67 =  max(tmp48, tmp66);
    const int32_t tmp7010 = (tmp67 & tmp7033);
    const int32_t tmp7234 = (tmp7010 + tmp7426);
    S11_ch tmp6684 = tmp6632.children(tmp7234);
    device float* tmp6685 = tmp6684.get0(runtime_, mem_alloc_).val;
    const auto tmp69 = *tmp6685;
    device float* tmp6697 = tmp6684.get1(runtime_, mem_alloc_).val;
    const auto tmp71 = *tmp6697;
    const int32_t tmp7250 = (tmp7010 + tmp7428);
    S11_ch tmp6708 = tmp6632.children(tmp7250);
    device float* tmp6709 = tmp6708.get0(runtime_, mem_alloc_).val;
    const auto tmp73 = *tmp6709;
    device float* tmp6721 = tmp6708.get1(runtime_, mem_alloc_).val;
    const auto tmp75 = *tmp6721;
    ...
    S1 tmp6728 = tmp6631.get0(runtime_, mem_alloc_);
    const int32_t tmp7038 = (tmp112 & tmp7189);
    const int32_t tmp7042 = (tmp115 & tmp7193);
    const int32_t tmp7430 = (tmp7038 << tmp6963);
    const int32_t tmp7266 = (tmp7042 + tmp7430);
    S1_ch tmp6732 = tmp6728.children(tmp7266);
    device float* tmp6733 = tmp6732.get0(runtime_, mem_alloc_).val;
    const auto tmp117 = *tmp6733;
    device float* tmp6745 = tmp6732.get1(runtime_, mem_alloc_).val;
    const auto tmp119 = *tmp6745;
    device float* tmp6757 = tmp6732.get2(runtime_, mem_alloc_).val;
    const auto tmp121 = *tmp6757;
    device float* tmp6769 = tmp6732.get3(runtime_, mem_alloc_).val;
    const auto tmp123 = *tmp6769;
    const int32_t tmp124 = (tmp104 + tmp57);
    const int32_t tmp125 =  min(tmp110, tmp124);
    const int32_t tmp126 =  max(tmp48, tmp125);
    const int32_t tmp7070 = (tmp126 & tmp7189);
    const int32_t tmp7432 = (tmp7070 << tmp6963);
    const int32_t tmp7298 = (tmp7042 + tmp7432);
    S1_ch tmp6780 = tmp6728.children(tmp7298);
    device float* tmp6781 = tmp6780.get0(runtime_, mem_alloc_).val;
    const auto tmp128 = *tmp6781;
    device float* tmp6793 = tmp6780.get1(runtime_, mem_alloc_).val;
    const auto tmp130 = *tmp6793;
    device float* tmp6805 = tmp6780.get2(runtime_, mem_alloc_).val;
    const auto tmp132 = *tmp6805;
    device float* tmp6817 = tmp6780.get3(runtime_, mem_alloc_).val;
    const auto tmp134 = *tmp6817;
    const int32_t tmp135 = (tmp105 + tmp57);
    const int32_t tmp136 =  min(tmp113, tmp135);
    const int32_t tmp137 =  max(tmp48, tmp136);
    const int32_t tmp7106 = (tmp137 & tmp7193);
    const int32_t tmp7330 = (tmp7106 + tmp7430);
    S1_ch tmp6828 = tmp6728.children(tmp7330);
    device float* tmp6829 = tmp6828.get0(runtime_, mem_alloc_).val;
    const auto tmp139 = *tmp6829;
    device float* tmp6841 = tmp6828.get1(runtime_, mem_alloc_).val;
    const auto tmp141 = *tmp6841;
    device float* tmp6853 = tmp6828.get2(runtime_, mem_alloc_).val;
    const auto tmp143 = *tmp6853;
    device float* tmp6865 = tmp6828.get3(runtime_, mem_alloc_).val;
    const auto tmp145 = *tmp6865;
    const int32_t tmp7362 = (tmp7106 + tmp7432);
    S1_ch tmp6876 = tmp6728.children(tmp7362);
    device float* tmp6877 = tmp6876.get0(runtime_, mem_alloc_).val;
    const auto tmp147 = *tmp6877;
    device float* tmp6889 = tmp6876.get1(runtime_, mem_alloc_).val;
    const auto tmp149 = *tmp6889;
    device float* tmp6901 = tmp6876.get2(runtime_, mem_alloc_).val;
    const auto tmp151 = *tmp6901;
    device float* tmp6913 = tmp6876.get3(runtime_, mem_alloc_).val;
    const auto tmp153 = *tmp6913;
    ...
    S6 tmp6920 = tmp6631.get1(runtime_, mem_alloc_);
    const int32_t tmp7434 = (tmp6966 << tmp6963);
    const int32_t tmp7394 = (tmp6970 + tmp7434);
    S6_ch tmp6924 = tmp6920.children(tmp7394);
    device float* tmp6925 = tmp6924.get0(runtime_, mem_alloc_).val;
    *tmp6925 = tmp193;
    device float* tmp6937 = tmp6924.get1(runtime_, mem_alloc_).val;
    *tmp6937 = tmp194;
    device float* tmp6949 = tmp6924.get2(runtime_, mem_alloc_).val;
    *tmp6949 = tmp195;
    device float* tmp6961 = tmp6924.get3(runtime_, mem_alloc_).val;
    *tmp6961 = tmp196;
  } else {
  }
}
...
kernel void mtl_k0010_advect_c4_2_0(
  ...
  for (int ii = begin_; ii < end_; ii += ugrid_size_) {
    mtl_k0010_advect_c4_2_0_func(root_addr, global_tmps_addr, ctx_addr, runtime_addr, print_assert_addr, ii);
  }
}
