...
This article will show you how to transfer data from external arrays To the Taichi scope and vice versa. External arrays refer to NumPy arrays, PyTorch tensors or Paddle Tensors, for now these are the only supported arrays.

We will use Numpy arrays as an example since this is the most common usage. The cases for PyTorch tentors and Paddle tensors are very similar.
