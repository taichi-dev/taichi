...
def shfl_sync_i32(mask, val, offset):
    ...
    return impl.call_internal(
        "cuda_shfl_sync_i32", mask, val, offset, 31, with_runtime_context=False
    )
...
def shfl_sync_f32(mask, val, offset):
    # lane offset is 31 for warp size 32
    return impl.call_internal(
        "cuda_shfl_sync_f32", mask, val, offset, 31, with_runtime_context=False
    )
...
def shfl_up_i32(mask, val, offset):
    ...
    return impl.call_internal(
        "cuda_shfl_up_sync_i32", mask, val, offset, 0, with_runtime_context=False
    )
...
def shfl_up_f32(mask, val, offset):
    # lane offset is 0 for warp size 32
    return impl.call_internal(
        "cuda_shfl_up_sync_f32", mask, val, offset, 0, with_runtime_context=False
    )
...
def shfl_down_i32(mask, val, offset):
    # lane offset is 31 for warp size 32
    return impl.call_internal(
        "cuda_shfl_down_sync_i32", mask, val, offset, 31, with_runtime_context=False
    )
...
def shfl_down_f32(mask, val, offset):
    # lane offset is 31 for warp size 32
    return impl.call_internal(
        "cuda_shfl_down_sync_f32", mask, val, offset, 31, with_runtime_context=False
    )


def shfl_xor_i32(mask, val, offset):
    return impl.call_internal(
        "cuda_shfl_xor_sync_i32", mask, val, offset, 31, with_runtime_context=False
    )
...
def match_any(mask, value):
    ...
    return impl.call_internal(
        "cuda_match_any_sync_i32", mask, value, with_runtime_context=False
    )
...
def match_all(mask, val):
    ...
    return impl.call_internal(
        "cuda_match_all_sync_i32", mask, val, with_runtime_context=False
    )
