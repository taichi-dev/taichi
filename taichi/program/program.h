...
class TI_DLL_EXPORT Program {
 public:
  ...
  // FIXME: Returning const ref is better, which is blocked by some tests.
  CompileConfig &global_compile_config() {
    return global_compile_config_;
  }
 ...
 private:
  ...
  CompileConfig global_compile_config_;
};
