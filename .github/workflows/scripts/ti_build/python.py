...
def setup_miniforge(prefix):
    ...
    if (u.system, u.machine) == ("Linux", "x86_64"):
        url = "https://github.com/conda-forge/miniforge/releases/download/25.1.1-0/Miniforge3-25.1.1-0-Linux-x86_64.sh"
        download_dep(url, prefix, args=["-bfp", str(prefix)])
    elif (u.system, u.machine) in (("Linux", "arm64"), ("Linux", "aarch64")):
        url = "https://github.com/conda-forge/miniforge/releases/download/25.1.1-0/Miniforge3-25.1.1-0-Linux-aarch64.sh"
        download_dep(url, prefix, args=["-bfp", str(prefix)])
    elif (u.system, u.machine) == ("Darwin", "arm64"):
        url = "https://github.com/conda-forge/miniforge/releases/download/25.1.1-0/Miniforge3-25.1.1-0-MacOSX-arm64.sh"
        download_dep(url, prefix, args=["-bfp", str(prefix)])
    elif (u.system, u.machine) == ("Darwin", "x86_64"):
        url = "https://github.com/conda-forge/miniforge/releases/download/25.1.1-0/Miniforge3-25.1.1-0-MacOSX-x86_64.sh"
        download_dep(url, prefix, args=["-bfp", str(prefix)])
    elif u.system == "Windows":
        url = (
            "https://github.com/conda-forge/miniforge/releases/download/25.1.1-0/Miniforge3-25.1.1-0-Windows-x86_64.exe"
        )
        download_dep(
            url,
            prefix,
