...
class Profiler:
    ...
    def get_total_time(self):
        ...
        self.count_results(
        )  # statistical results : total_time_ms_ is counted here
    ...
    def count_results(self):
        ...
        for record in self.traced_records_:
            if self.statistical_results_.get(record.name) == None:
                self.statistical_results_[record.name] = StatisticalResult(
                    record.name)
            self.statistical_results_[record.name].insert_record(
                record.kernel_time)
            self.total_time_ms_ += record.kernel_time
        self.statistical_results_ = {
            k: v
            for k, v in sorted(self.statistical_results_.items(),
    ...
    def print_info(self, mode=count):
        ...
        if mode == self.count:
            ...
            print(
                ...
                .format(self.total_time_ms_, len(self.statistical_results_)))
            print(
                "========================================================================="
            )
