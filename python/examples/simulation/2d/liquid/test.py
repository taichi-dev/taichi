...
if __name__ == '__main__':
    ...
    simulator = FluidSimulator(simulator='liquid', simulation_width=resolution[0],
                               ...
                               simulation_time=3, dt=0.1, levelset_band=3, tolerance=1e-4, maximum_iterations=1000,
                               show_pressure=True)
    ...
    window = SimulationWindow(640, simulator, color_schemes['liquid'], levelset_supersampling=2, show_grid=True)
