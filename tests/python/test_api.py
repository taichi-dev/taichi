...
user_api[ti.math] = [
    ...
    'distance', 'dot', 'e', 'exp', 'eye', 'floor', 'fract', 'inf', 'inverse', 'isinf', 'isnan', 'ivec2',
    'ivec3', 'ivec4', 'length', 'log', 'log2', 'mat2', 'mat3', 'mat4', 'max',
    'min', 'mix', 'mod', 'nan', 'normalize', 'pi', 'pow', 'radians', 'reflect',
    'refract', 'rot2', 'rot3', 'rotate2d', 'rotate3d', 'round', 'sign', 'sin',
    'smoothstep', 'sqrt', 'step', 'tan', 'tanh', 'uvec2', 'uvec3', 'uvec4', 'vdir',
    'vec2', 'vec3', 'vec4'
]
