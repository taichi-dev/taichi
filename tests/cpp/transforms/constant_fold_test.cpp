...
TEST_F(ConstantFoldTest, UnaryNeg) {
  auto *x = builder.create_arg_load({0}, get_data_type<float>(), false, false);
...
TEST_F(ConstantFoldTest, BinaryBitShrInt32) {
  auto *x = builder.create_arg_load({0}, get_data_type<int>(), false, false);
  auto *lhs = builder.get_int32(-1);
...
TEST_F(ConstantFoldTest, BinaryBitShrInt64) {
  auto *x = builder.create_arg_load({0}, get_data_type<int64_t>(), false, false);
