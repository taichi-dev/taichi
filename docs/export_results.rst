...
.. note::
    ...
    All Taichi tensors have their own datatypes, such as ``ti.u8`` and ``ti.f32``. Different datatype can make ``ti.imwrite`` have different behaviors. Please check out :ref:`gui` for more details.
