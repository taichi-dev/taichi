...
if __name__ == '__main__':
    ...
    simulator = create_mpm_simulator(resolution, 20, 0.1)

    simulator.add_event(-1, lambda s: s.add_particles_polygon([(0.05, 0.75), (1.2, 0.05), (1.2, 0.08), (0.05, 0.78)],
                                                        'ep', compression=1.1))
    simulator.add_event(-1, lambda s: s.add_particles_sphere(Vector(0.12, 0.85), 0.06, 'ep', compression=0.8, velocity=Vector(0.0, -0.1)))
