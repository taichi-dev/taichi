...
FunctionType VulkanProgramImpl::compile(Kernel *kernel, OffloadedStmt *offloaded){
    vulkan::lower(kernel);
...
void VulkanProgramImpl::materialize_runtime(MemoryPool *memory_pool,
    ...
    *result_buffer_ptr = (uint64 *)memory_pool->allocate(
    ...
    // doesn't do anything other than alloc result buffer. runtime is materialized together with snode tree.
