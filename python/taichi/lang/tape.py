class TapeImpl:
    ...
    def __enter__(self):
        ...
        assert self.entered is False, "Tape can be entered only once."
        self.entered = True
    ...
    def grad(self):
        assert self.entered is True, "Before evaluating gradients tape must be entered."
        assert self.gradient_evaluated is False, "Gradients of grad can be evaluated only once."
