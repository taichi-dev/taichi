...
if (TI_WITH_OPENGL)
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DTI_WITH_OPENGL -DGLEW_STATIC -DGLEW_NO_GLU")

  set(GLEW_USE_STATIC_LIBS ON CACHE BOOL "Link statically against GLEW")
  set(OpenGL_GL_PREFERENCE GLVND)
  message("Building with GLEW (glew-ready)")
  add_subdirectory(external/glew-ready/build/cmake glew.out)
  target_include_directories(${LIBRARY_NAME} PUBLIC external/glew-ready/include)
  target_link_directories(${LIBRARY_NAME} PUBLIC external/glew-ready/build/cmake/lib)
