...
__aot_test_cases = {
    "LlvmAotTest.CpuKernel": ['cpu', 'cpp/aot/llvm/kernel_aot_test.py', ""],
    "LlvmAotTest.CudaKernel": ['cuda', 'cpp/aot/llvm/kernel_aot_test.py', ""],
    "LlvmAotTest.CpuField": ['cpu', 'cpp/aot/llvm/field_aot_test.py', ""],
    "LlvmAotTest.CudaField": ['cuda', 'cpp/aot/llvm/field_aot_test.py', ""],
    "LlvmCGraph.RunGraphCpu": ['cpu', 'cpp/aot/llvm/graph_aot_test.py', ""],
    "LlvmCGraph.RunGraphCuda": ['cuda', 'cpp/aot/llvm/graph_aot_test.py', ""],
    "LlvmCGraph.CpuField":
    ['cpu', 'cpp/aot/llvm/field_aot_test.py', "--cgraph"],
    "LlvmCGraph.CudaField":
    ['cuda', 'cpp/aot/llvm/field_aot_test.py', "--cgraph"],
    "LlvmCGraph.Mpm88Cpu": ['cpu', 'cpp/aot/mpm88_graph_aot.py', ""],
    "LlvmCGraph.Mpm88Cuda": ['cuda', 'cpp/aot/mpm88_graph_aot.py', ""],
    "AotLoadGraph.Mpm88": ['vulkan', 'cpp/aot/mpm88_graph_aot.py', ""],
}

__capi_aot_test_cases = {
    "CapiAotTest.CpuField": ['cpu', 'cpp/aot/llvm/field_aot_test.py', ""],
    "CapiAotTest.CudaField": ['cuda', 'cpp/aot/llvm/field_aot_test.py', ""],
    "CapiGraphTest.CpuGraph": ['cpu', 'cpp/aot/llvm/graph_aot_test.py', ""],
    "CapiGraphTest.CudaGraph": ['cuda', 'cpp/aot/llvm/graph_aot_test.py', ""],
    "CapiAotTest.CpuKernel": ['cpu', 'cpp/aot/llvm/kernel_aot_test.py', ""],
    "CapiAotTest.CudaKernel": ['cuda', 'cpp/aot/llvm/kernel_aot_test.py', ""],
    "CapiDryRun.VulkanAotModule":
    ['cpu', 'cpp/aot/llvm/kernel_aot_test.py', ""],
}
...
the format of which follows:
        ...
        "cpp_test_name" : ["arch", "python_program_path", "--arguments"]

For example:

        "LlvmProgramTest.FullPipeline": ["cpu", "cpp/aot/llvm/kernel_aot_test.py", ""]
