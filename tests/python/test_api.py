...
user_api[ti] = [
    ...
    'deactivate', 'deactivate_all_snodes', 'dx11', 'eig', 'exp', 'ext_arr',
    'extension', 'f16', 'f32', 'f64', 'field', 'float16', 'float32', 'float64',
    'floor', 'func', 'get_addr', 'global_thread_idx', 'gpu', 'grouped',
    ...
    'lang', 'length', 'linalg', 'log', 'max', 'mesh_local', 'mesh_patch_idx',
    'metal', 'min', 'ndarray', 'ndrange', 'no_activate', 'one', 'opengl',
    'parallelize', 'polar_decompose', 'pow', 'profiler', 'randn', 'random',
