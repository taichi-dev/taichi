...
def tix_enqueue_task_async_unity(user_data: ctypes.c_void_p, async_task: TixAsyncTaskUnity) -> None:
    """
...
def tix_copy_memory_host_to_device_unity(
    runtime: TiRuntime, dst: ctypes.c_void_p, src: ctypes.c_void_p, src_offset: ctypes.c_uint64  # const TiMemorySlice*,
) -> None:
    """
...
def tix_submit_async_unity(runtime: TiRuntime) -> ctypes.c_void_p:
    """
