...
option(TI_WITH_CUDA_TOOLKIT "Build with CUDA toolkit" OFF)
...
if (TI_WITH_CUDA_TOOLKIT)
    message("TI_WITH_CUDA_TOOLKIT ON")
    message("CUDA_TOOLKIT_ROOT_DIR=$ENV{CUDA_TOOLKIT_ROOT_DIR}")
    ...
    message("TI_WITH_CUDA_TOOLKIT OFF")
    message("CUDA_TOOLKIT_ROOT_DIR=$ENV{CUDA_TOOLKIT_ROOT_DIR}")
endif()
