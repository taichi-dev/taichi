...
window = ti.ui.Window("Cloth Simulation on GGUI", (1024, 1024), vsync=True)
canvas = window.get_canvas()
canvas.set_background_color((0.8, 1.0, 0.8))
scene = ti.ui.Scene()
...
while window.running:
    ...
    scene.point_light(pos=(0.0, 10.0, 20.0), color=(1.0, 1.0, 1.0))
