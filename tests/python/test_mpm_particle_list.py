...
@ti.test(require=ti.extension.sparse, use_unified_memory=False, device_memory_GB=0.3)
...
@ti.test(require=[ti.extension.sparse, ti.extension.packed], use_unified_memory=False, device_memory_GB=0.3, packed=True)
