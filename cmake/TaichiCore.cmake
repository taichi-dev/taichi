...
if (TI_WITH_VULKAN)
    ...
    if (APPLE)
        message("HOMEBREW_CELLAR=$ENV{HOMEBREW_CELLAR}")
        find_library(MOLTEN_VK libMoltenVK.dylib PATHS $ENV{HOMEBREW_CELLAR}/molten-vk/molten-vk/1.1.8/lib $VULKAN_SDK REQUIRED)
