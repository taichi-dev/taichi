...
TEST(AliasAnalysis, ExternalPtr_Same) {
  IRBuilder builder;
  auto *arg1 = builder.create_arg_load({1}, PrimitiveType::i32, true, false);
  auto *arg2 = builder.create_arg_load({2}, PrimitiveType::i32, false, false);
...
TEST(AliasAnalysis, ExternalPtr_Uncertain) {
  ...
  auto *arg1 = builder.create_arg_load({1}, PrimitiveType::i32, true, false);
  auto *arg2 = builder.create_arg_load({2}, PrimitiveType::i32, false, false);
  auto *arg3 = builder.create_arg_load({3}, PrimitiveType::i32, false, false);
...
TEST(AliasAnalysis, ExternalPtr_DiffPtr) {
  IRBuilder builder;
  auto *arg1 = builder.create_arg_load({1}, PrimitiveType::i32, true, false);
  auto *arg2 = builder.create_arg_load({2}, PrimitiveType::i32, true, false);
  auto *arg3 = builder.create_arg_load({3}, PrimitiveType::i32, false, false);
...
TEST(AliasAnalysis, ExternalPtr_GradSame) {
  IRBuilder builder;
  auto *arg1 = builder.create_arg_load({1}, PrimitiveType::i32, true, false);
  auto *arg2 = builder.create_arg_load({1}, PrimitiveType::i32, true, false);
  auto *arg3 = builder.create_arg_load({2}, PrimitiveType::i32, false, false);
  const auto indices = std::vector<Stmt *>{arg3, arg3};
  auto *eptr1 = builder.create_external_ptr(arg1, indices);
  auto *eptr2 = builder.create_external_ptr(arg2, indices);
