std::tuple<Matrix, Matrix, Matrix> svd(const Matrix &a) {
  ...
  For(i, 0, 5, [&] {
    ...
    Stmp2 = float32_bitwise_and(Expr(~Stmp1), Sone);
  ...
  Stmp1 = Stmp1 * Stmp2;
  Sch = Sch + Stmp1;
  Stmp1 = float32_bitwise_and(Expr(~Stmp5), Ssh);
  Stmp2 = float32_bitwise_and(Expr(~Stmp5), Sch);
