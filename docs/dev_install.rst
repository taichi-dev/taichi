...
Then use Visual Studio (Build Tools) to build. Then build the ``INSTALL`` project (under folder "CMakePredefinedTargets"). Once the build completes, find your LLVM binaries/headers in `build/include`.
