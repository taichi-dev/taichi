...
void mtl_k0004_advect_c4_0_0_func(
  ...
  constexpr int32_t tmp1819 = 8;
  const int32_t tmp1820 = (tmp3 >> tmp1819);
  const int32_t tmp1822 = (tmp1820 & tmp1969);
  ...
  if (tmp18) {
    ...
    const int32_t tmp1830 = (tmp49 & tmp1969);
    ...
    const int32_t tmp1846 = (tmp60 & tmp1969);
    ...
    const int32_t tmp1894 = (tmp112 & tmp1969);
    ...
    const int32_t tmp1910 = (tmp122 & tmp1969);
