...
function build-and-smoke-test-android-aot-demo {
    ...
    git clone https://github.com/PENGUINLIONG/taichi-aot-demo -b allow-merged-pr
...
function build-and-test-headless-demo {
    ...
    rm -rf taichi-aot-demo
    git clone --recursive --depth=1 https://github.com/PENGUINLIONG/taichi-aot-demo -b allow-merged-pr
    cd taichi-aot-demo
