...
user_api[ti] = [
    ...
    'func', 'fwdAD', 'get_addr', 'global_thread_idx', 'gpu', 'graph',
    'grouped', 'hex_to_rgb', 'i', 'i16', 'i32', 'i64', 'i8', 'ij', 'ijk',
    'ijkl', 'ijl', 'ik', 'ikl', 'il', 'init', 'int16', 'int32', 'int64',
    ...
    'sqrt', 'static', 'static_assert', 'static_print', 'stop_grad',
    'struct_class', 'svd', 'swizzle_generator', 'sym_eig', 'sync', 'tan',
    'tanh', 'template', 'tools', 'types', 'u16', 'u32', 'u64', 'u8', 'ui',
    'uint16', 'uint32', 'uint64', 'uint8', 'vulkan', 'wasm', 'x64', 'x86_64',
    'zero'
]
user_api[ti.Field] = [
