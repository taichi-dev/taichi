...
kernel_profiler_disable = _ti_core.KernelProfilingMode.disable
kernel_profiler_enable = _ti_core.KernelProfilingMode.enable
# CUDA backend
cuda_event = _ti_core.KernelProfilingMode.enable
cuda_accurate = _ti_core.KernelProfilingMode.cuda_accurate
cuda_detailed = _ti_core.KernelProfilingMode.cuda_detailed
