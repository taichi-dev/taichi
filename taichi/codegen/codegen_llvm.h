...
class CodeGenLLVM : public IRVisitor, public LLVMModuleBuilder {
 public:
  ...
  llvm::Value *atomic_add_quant_fixed(AtomicOpStmt *stmt, QuantFixedType *cfxt);

  llvm::Value *atomic_add_quant_int(AtomicOpStmt *stmt, QuantIntType *cit);

  llvm::Value *quant_fixed_to_quant_int(QuantFixedType *cfxt,
                                        QuantIntType *cit,
                                        llvm::Value *real);
  ...
  llvm::Value *get_exponent_offset(llvm::Value *exponent, QuantFloatType *cft);
