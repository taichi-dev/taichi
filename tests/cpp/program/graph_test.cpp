...
//   1}; seq->dispatch(ker1.get(), {arr_arg}); seq->dispatch(ker2.get(),
//   {arr_arg, aot::Arg{
//                                           aot::ArgKind::kScalar,
//                                           "x",
//                                           PrimitiveType::i32,
...
//   g->jit_run(test_prog.prog(), test_prog.prog()->global_compile_config(),
//   args); test_prog.prog()->synchronize(); EXPECT_EQ(array.read_int({0}), 2);
