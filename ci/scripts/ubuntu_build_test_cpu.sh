...
TAICHI_CMAKE_ARGS="-DTI_WITH_VULKAN:BOOL=OFF -DTI_WITH_CUDA:BOOL=OFF -DTI_WITH_OPENGL:BOOL=OFF -DTI_EXPORT_CORE=ON -DTI_BUILD_TESTS=ON" python3 setup.py install
