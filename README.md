...
## Updates
 - (Oct 7, 2019) I have released **experimental** python **3.6** wheels on Linux (tested on Ubuntu 16.04/18.04) for those who are eager to try. More stable releases are coming in a few days. To install them: 
```bash
