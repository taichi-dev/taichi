...
class mtl_k0006_advect_c4_0_args {
 public:
  explicit mtl_k0006_advect_c4_0_args(device byte* addr) : addr_(addr) {}
  device float* arg0() {
    // scalar, size=4 B
...
void mtl_k0006_advect_c4_0_0_func(
  ...
  mtl_k0006_advect_c4_0_args kernel_ctx_(ctx_addr);
  ...
  constexpr int32_t tmp2203 = 1023;
  constexpr int32_t tmp2199 = 511;
  ...
  constexpr int32_t tmp2053 = 10;
  const int32_t tmp2054 = (tmp3 >> tmp2053);
  const int32_t tmp2056 = (tmp2054 & tmp2199);
  const int32_t tmp2060 = (tmp3 & tmp2203);
  constexpr int32_t tmp13 = 417;
  const int32_t tmp14 = -(tmp2056 < tmp13);
  constexpr int32_t tmp16 = 597;
  const int32_t tmp17 = -(tmp2060 < tmp16);
  const int32_t tmp18 = (tmp14 & tmp17);
  if (tmp18) {
    const int32_t tmp20 = *kernel_ctx_.arg1();
    const int32_t tmp21 = *kernel_ctx_.arg2();
    const float tmp22 = static_cast<float>(tmp2056);
    const float tmp24 = (tmp22 + tmp23);
    const float tmp25 = static_cast<float>(tmp2060);
    ...
    S0 tmp1839(root_addr);
    S0_ch tmp1841 = tmp1839.children(tmp48);
    S11 tmp1842 = tmp1841.get2(runtime_, mem_alloc_);
    const int32_t tmp2064 = (tmp49 & tmp2199);
    const int32_t tmp2068 = (tmp52 & tmp2203);
    const int32_t tmp2356 = (tmp2064 << tmp2053);
    const int32_t tmp2212 = (tmp2068 + tmp2356);
    S11_ch tmp1846 = tmp1842.children(tmp2212);
    device float* tmp1847 = tmp1846.get0(runtime_, mem_alloc_).val;
    const auto tmp54 = *tmp1847;
    device float* tmp1859 = tmp1846.get1(runtime_, mem_alloc_).val;
    const auto tmp56 = *tmp1859;
    const int32_t tmp58 = (tmp40 + tmp57);
    const int32_t tmp59 =  min(tmp46, tmp58);
    const int32_t tmp60 =  max(tmp48, tmp59);
    const int32_t tmp2080 = (tmp60 & tmp2199);
    const int32_t tmp2358 = (tmp2080 << tmp2053);
    const int32_t tmp2228 = (tmp2068 + tmp2358);
    S11_ch tmp1870 = tmp1842.children(tmp2228);
    device float* tmp1871 = tmp1870.get0(runtime_, mem_alloc_).val;
    const auto tmp62 = *tmp1871;
    device float* tmp1883 = tmp1870.get1(runtime_, mem_alloc_).val;
    const auto tmp64 = *tmp1883;
    const int32_t tmp65 = (tmp41 + tmp57);
    const int32_t tmp66 =  min(tmp50, tmp65);
    const int32_t tmp67 =  max(tmp48, tmp66);
    const int32_t tmp2100 = (tmp67 & tmp2203);
    const int32_t tmp2244 = (tmp2100 + tmp2356);
    S11_ch tmp1894 = tmp1842.children(tmp2244);
    device float* tmp1895 = tmp1894.get0(runtime_, mem_alloc_).val;
    const auto tmp69 = *tmp1895;
    device float* tmp1907 = tmp1894.get1(runtime_, mem_alloc_).val;
    const auto tmp71 = *tmp1907;
    const int32_t tmp2260 = (tmp2100 + tmp2358);
    S11_ch tmp1918 = tmp1842.children(tmp2260);
    device float* tmp1919 = tmp1918.get0(runtime_, mem_alloc_).val;
    const auto tmp73 = *tmp1919;
    device float* tmp1931 = tmp1918.get1(runtime_, mem_alloc_).val;
    const auto tmp75 = *tmp1931;
    ...
    const int32_t tmp2128 = (tmp112 & tmp2199);
    const int32_t tmp2132 = (tmp115 & tmp2203);
    const int32_t tmp2360 = (tmp2128 << tmp2053);
    const int32_t tmp2276 = (tmp2132 + tmp2360);
    S11_ch tmp1942 = tmp1842.children(tmp2276);
    device float* tmp1943 = tmp1942.get0(runtime_, mem_alloc_).val;
    const auto tmp117 = *tmp1943;
    device float* tmp1955 = tmp1942.get1(runtime_, mem_alloc_).val;
    const auto tmp119 = *tmp1955;
    const int32_t tmp120 = (tmp104 + tmp57);
    const int32_t tmp121 =  min(tmp110, tmp120);
    const int32_t tmp122 =  max(tmp48, tmp121);
    const int32_t tmp2144 = (tmp122 & tmp2199);
    const int32_t tmp2362 = (tmp2144 << tmp2053);
    const int32_t tmp2292 = (tmp2132 + tmp2362);
    S11_ch tmp1966 = tmp1842.children(tmp2292);
    device float* tmp1967 = tmp1966.get0(runtime_, mem_alloc_).val;
    const auto tmp124 = *tmp1967;
    device float* tmp1979 = tmp1966.get1(runtime_, mem_alloc_).val;
    const auto tmp126 = *tmp1979;
    const int32_t tmp127 = (tmp105 + tmp57);
    const int32_t tmp128 =  min(tmp113, tmp127);
    const int32_t tmp129 =  max(tmp48, tmp128);
    const int32_t tmp2164 = (tmp129 & tmp2203);
    const int32_t tmp2308 = (tmp2164 + tmp2360);
    S11_ch tmp1990 = tmp1842.children(tmp2308);
    device float* tmp1991 = tmp1990.get0(runtime_, mem_alloc_).val;
    const auto tmp131 = *tmp1991;
    device float* tmp2003 = tmp1990.get1(runtime_, mem_alloc_).val;
    const auto tmp133 = *tmp2003;
    const int32_t tmp2324 = (tmp2164 + tmp2362);
    S11_ch tmp2014 = tmp1842.children(tmp2324);
    device float* tmp2015 = tmp2014.get0(runtime_, mem_alloc_).val;
    const auto tmp135 = *tmp2015;
    device float* tmp2027 = tmp2014.get1(runtime_, mem_alloc_).val;
    const auto tmp137 = *tmp2027;
    ...
    S14 tmp2034 = tmp1841.get3(runtime_, mem_alloc_);
    const int32_t tmp2364 = (tmp2056 << tmp2053);
    const int32_t tmp2340 = (tmp2060 + tmp2364);
    S14_ch tmp2038 = tmp2034.children(tmp2340);
    device float* tmp2039 = tmp2038.get0(runtime_, mem_alloc_).val;
    *tmp2039 = tmp159;
    device float* tmp2051 = tmp2038.get1(runtime_, mem_alloc_).val;
    *tmp2051 = tmp160;
  } else {
  }
}
...
kernel void mtl_k0006_advect_c4_0_0(
  ...
  for (int ii = begin_; ii < end_; ii += ugrid_size_) {
    mtl_k0006_advect_c4_0_0_func(root_addr, global_tmps_addr, ctx_addr, runtime_addr, print_assert_addr, ii);
  }
}
