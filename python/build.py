...
shutil.rmtree('taichi/external', ignore_errors=True)
os.makedirs('taichi/lib', exist_ok=True)
os.makedirs('taichi/external', exist_ok=True)
...
shutil.copytree('../external/fonts', './taichi/external/fonts')
