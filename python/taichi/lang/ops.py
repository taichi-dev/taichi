...
def pow(x, a):  # pylint: disable=W0622
    ...
    Args:
        x (Union[:mod:`~taichi.types.primitive_types`, :class:`~taichi.Matrix`]): \
            The bases.
        a (:mod:`~taichi.types.primitive_types`, :class:`~taichi.Matrix`]): \
            The exponents.
...
def raw_mod(x1, x2):
    ...
    Args:
        x1 (Union[:mod:`~taichi.types.primitive_types`, :class:`~taichi.Matrix`]): The dividend scalar or matrix.
        x2 (Union[:mod:`~taichi.types.primitive_types`, :class:`~taichi.Matrix`]): The divisor scalar or matrix.
...
def select(cond, x1, x2):
    ...
    Args:
        cond (Union[:mod:`~taichi.types.primitive_types`, :class:`~taichi.Matrix`]): \
            The array of conditions which determine from which of `x1` and `x2` the \
                output elements are taken.
        x1, x2 (Union[:mod:`~taichi.types.primitive_types`, :class:`~taichi.Matrix`]): \
            The arrays from which the output elements are taken.
