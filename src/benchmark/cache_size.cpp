...
class CacheStridedReadBenchmark : public Benchmark {
 ...
 public:
  void initialize(const Config &config) override {
    ...
    assert_info(working_set_size % 4 == 0,
                "working_set_size should be a multiple of 4");
    assert_info((working_set_size & (working_set_size - 1)) == 0,
                "working_set_size should be a power of 2");
