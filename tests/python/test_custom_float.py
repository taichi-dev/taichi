...
def test_custom_matrix_rotation():
    ...
    ti.root.bit_struct(num_bits=32).place(x.get_scalar_field(0, 0), x.get_scalar_field(0, 1))
    ti.root.bit_struct(num_bits=32).place(x.get_scalar_field(1, 0), x.get_scalar_field(1, 1))
