...
def test_custom_type():
    ...
    ti.root.dense(ti.i, 1).bit_struct(num_bits=32).place(a.get_scalar_field(0, 0), a.get_scalar_field(0, 1))
    ti.root.dense(ti.i, 1).bit_struct(num_bits=32).place(a.get_scalar_field(1, 0), a.get_scalar_field(1, 1))
    ti.root.dense(ti.i, 1).bit_struct(num_bits=32).place(b.get_scalar_field(0, 0), b.get_scalar_field(0, 1))
    ti.root.dense(ti.i, 1).bit_struct(num_bits=32).place(b.get_scalar_field(1, 0), b.get_scalar_field(1, 1))
    ti.root.dense(ti.i, 1).bit_struct(num_bits=32).place(c.get_scalar_field(0, 0), c.get_scalar_field(0, 1))
    ti.root.dense(ti.i, 1).bit_struct(num_bits=32).place(c.get_scalar_field(1, 0), c.get_scalar_field(1, 1))
