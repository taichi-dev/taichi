...
if (TI_WITH_VULKAN)
    ...
    if (APPLE)
        ...
        find_library(MOLTEN_VK_VULKAN libvulkan.dylib PATHS $HOMEBREW_CELLAR/molten-vk $VULKAN_SDK REQUIRED)
        configure_file(${MOLTEN_VK} ${CMAKE_BINARY_DIR}/libMoltenVK.dylib COPYONLY)
        configure_file(${MOLTEN_VK_VULKAN} ${CMAKE_BINARY_DIR}/libvulkan.dylib COPYONLY)
        ...
        message(STATUS "MoltenVK Vulkan library ${MOLTEN_VK_VULKAN}")
        if (EXISTS ${CMAKE_BINARY_DIR}/libvulkan.dylib)
            install(FILES ${CMAKE_BINARY_DIR}/libvulkan.dylib DESTINATION ${INSTALL_LIB_DIR}/runtime)
        endif()
    endif()
