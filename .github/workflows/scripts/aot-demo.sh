...
function prepare-unity-build-env {
    ...
    # Dependencies
    git clone --reference-if-able /var/lib/git-cache https://github.com/damnkk/Taichi-UnityExample -b debug1
    ...
    git clone --reference-if-able /var/lib/git-cache -b debug_unity https://github.com/damnkk/JYF_taichi-unity2 JYF_taichi-unity2
    mkdir tu2-build
    pushd tu2-build
