...
In general, compound statements span multiple lines,
...
the following is illegal, mostly because it wouldn’t be clear to
...
so that in the following example, either all or none of the `print()` calls are executed:
