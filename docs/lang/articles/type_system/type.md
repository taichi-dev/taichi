...
Such types can be directly called to create the corresponding vector/matrix instances, and can also be used as type notifiers in function arguments and struct members. For example:
