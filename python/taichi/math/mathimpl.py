...
vec3 = ti.types.vector(3, impl.get_runtime().default_fp)
"""3D floating vector type.
"""

vec4 = ti.types.vector(4, impl.get_runtime().default_fp)
"""4D floating vector type.
"""

ivec2 = ti.types.vector(2, impl.get_runtime().default_ip)
"""2D signed int vector type.
"""

ivec3 = ti.types.vector(3, impl.get_runtime().default_ip)
"""3D signed int vector type.
"""

ivec4 = ti.types.vector(4, impl.get_runtime().default_ip)
...
mat2 = ti.types.matrix(2, 2, impl.get_runtime().default_fp)
"""2x2 floating matrix type.
"""

mat3 = ti.types.matrix(3, 3, impl.get_runtime().default_fp)
"""3x3 floating matrix type.
"""

mat4 = ti.types.matrix(4, 4, impl.get_runtime().default_fp)
