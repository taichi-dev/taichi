...
VulkanSurface::VulkanSurface(VulkanDevice *device, const SurfaceConfig &config)
  ...
  void VulkanSurface::create_swap_chain() {
    ...
    vkGetPhysicalDeviceSurfaceFormatsKHR(device_->vk_physical_device(),
                                         surface_, &formatCount, nullptr);
  ...
  DeviceAllocation VulkanSurface::get_depth_data(DeviceAllocation &
                                                 depth_alloc) {
  ...
  VulkanStream::VulkanStream(VulkanDevice & device, VkQueue queue,
