...
class mtl_k0004_advect_c4_0_args {
 public:
  explicit mtl_k0004_advect_c4_0_args(device byte* addr) : addr_(addr) {}
  device float* arg0() {
    // scalar, size=4 B
...
void mtl_k0004_advect_c4_0_0_func(
  ...
  mtl_k0004_advect_c4_0_args kernel_ctx_(ctx_addr);
  ...
  constexpr int32_t tmp1969 = 1023;
  constexpr int32_t tmp1965 = 511;
  ...
  constexpr int32_t tmp1819 = 10;
  const int32_t tmp1820 = (tmp3 >> tmp1819);
  const int32_t tmp1822 = (tmp1820 & tmp1965);
  const int32_t tmp1826 = (tmp3 & tmp1969);
  constexpr int32_t tmp13 = 417;
  const int32_t tmp14 = -(tmp1822 < tmp13);
  constexpr int32_t tmp16 = 597;
  const int32_t tmp17 = -(tmp1826 < tmp16);
  const int32_t tmp18 = (tmp14 & tmp17);
  if (tmp18) {
    const int32_t tmp20 = *kernel_ctx_.arg1();
    const int32_t tmp21 = *kernel_ctx_.arg2();
    const float tmp22 = static_cast<float>(tmp1822);
    const float tmp24 = (tmp22 + tmp23);
    const float tmp25 = static_cast<float>(tmp1826);
    ...
    S0 tmp1605(root_addr);
    S0_ch tmp1607 = tmp1605.children(tmp48);
    S11 tmp1608 = tmp1607.get2(runtime_, mem_alloc_);
    const int32_t tmp1830 = (tmp49 & tmp1965);
    const int32_t tmp1834 = (tmp52 & tmp1969);
    const int32_t tmp2128 = (tmp1830 << tmp1819);
    const int32_t tmp1978 = (tmp1834 + tmp2128);
    S11_ch tmp1612 = tmp1608.children(tmp1978);
    device float* tmp1613 = tmp1612.get0(runtime_, mem_alloc_).val;
    const auto tmp54 = *tmp1613;
    device float* tmp1625 = tmp1612.get1(runtime_, mem_alloc_).val;
    const auto tmp56 = *tmp1625;
    const int32_t tmp58 = (tmp40 + tmp57);
    const int32_t tmp59 =  min(tmp46, tmp58);
    const int32_t tmp60 =  max(tmp48, tmp59);
    const int32_t tmp1846 = (tmp60 & tmp1965);
    const int32_t tmp2130 = (tmp1846 << tmp1819);
    const int32_t tmp1994 = (tmp1834 + tmp2130);
    S11_ch tmp1636 = tmp1608.children(tmp1994);
    device float* tmp1637 = tmp1636.get0(runtime_, mem_alloc_).val;
    const auto tmp62 = *tmp1637;
    device float* tmp1649 = tmp1636.get1(runtime_, mem_alloc_).val;
    const auto tmp64 = *tmp1649;
    const int32_t tmp65 = (tmp41 + tmp57);
    const int32_t tmp66 =  min(tmp50, tmp65);
    const int32_t tmp67 =  max(tmp48, tmp66);
    const int32_t tmp1866 = (tmp67 & tmp1969);
    const int32_t tmp2010 = (tmp1866 + tmp2128);
    S11_ch tmp1660 = tmp1608.children(tmp2010);
    device float* tmp1661 = tmp1660.get0(runtime_, mem_alloc_).val;
    const auto tmp69 = *tmp1661;
    device float* tmp1673 = tmp1660.get1(runtime_, mem_alloc_).val;
    const auto tmp71 = *tmp1673;
    const int32_t tmp2026 = (tmp1866 + tmp2130);
    S11_ch tmp1684 = tmp1608.children(tmp2026);
    device float* tmp1685 = tmp1684.get0(runtime_, mem_alloc_).val;
    const auto tmp73 = *tmp1685;
    device float* tmp1697 = tmp1684.get1(runtime_, mem_alloc_).val;
    const auto tmp75 = *tmp1697;
    ...
    const int32_t tmp1894 = (tmp112 & tmp1965);
    const int32_t tmp1898 = (tmp115 & tmp1969);
    const int32_t tmp2132 = (tmp1894 << tmp1819);
    const int32_t tmp2042 = (tmp1898 + tmp2132);
    S11_ch tmp1708 = tmp1608.children(tmp2042);
    device float* tmp1709 = tmp1708.get0(runtime_, mem_alloc_).val;
    const auto tmp117 = *tmp1709;
    device float* tmp1721 = tmp1708.get1(runtime_, mem_alloc_).val;
    const auto tmp119 = *tmp1721;
    const int32_t tmp120 = (tmp104 + tmp57);
    const int32_t tmp121 =  min(tmp110, tmp120);
    const int32_t tmp122 =  max(tmp48, tmp121);
    const int32_t tmp1910 = (tmp122 & tmp1965);
    const int32_t tmp2134 = (tmp1910 << tmp1819);
    const int32_t tmp2058 = (tmp1898 + tmp2134);
    S11_ch tmp1732 = tmp1608.children(tmp2058);
    device float* tmp1733 = tmp1732.get0(runtime_, mem_alloc_).val;
    const auto tmp124 = *tmp1733;
    device float* tmp1745 = tmp1732.get1(runtime_, mem_alloc_).val;
    const auto tmp126 = *tmp1745;
    const int32_t tmp127 = (tmp105 + tmp57);
    const int32_t tmp128 =  min(tmp113, tmp127);
    const int32_t tmp129 =  max(tmp48, tmp128);
    const int32_t tmp1930 = (tmp129 & tmp1969);
    const int32_t tmp2074 = (tmp1930 + tmp2132);
    S11_ch tmp1756 = tmp1608.children(tmp2074);
    device float* tmp1757 = tmp1756.get0(runtime_, mem_alloc_).val;
    const auto tmp131 = *tmp1757;
    device float* tmp1769 = tmp1756.get1(runtime_, mem_alloc_).val;
    const auto tmp133 = *tmp1769;
    const int32_t tmp2090 = (tmp1930 + tmp2134);
    S11_ch tmp1780 = tmp1608.children(tmp2090);
    device float* tmp1781 = tmp1780.get0(runtime_, mem_alloc_).val;
    const auto tmp135 = *tmp1781;
    device float* tmp1793 = tmp1780.get1(runtime_, mem_alloc_).val;
    const auto tmp137 = *tmp1793;
    ...
    S14 tmp1800 = tmp1607.get3(runtime_, mem_alloc_);
    const int32_t tmp2136 = (tmp1822 << tmp1819);
    const int32_t tmp2106 = (tmp1826 + tmp2136);
    S14_ch tmp1804 = tmp1800.children(tmp2106);
    device float* tmp1805 = tmp1804.get0(runtime_, mem_alloc_).val;
    *tmp1805 = tmp159;
    device float* tmp1817 = tmp1804.get1(runtime_, mem_alloc_).val;
    *tmp1817 = tmp160;
  } else {
  }
}
...
kernel void mtl_k0004_advect_c4_0_0(
  ...
  for (int ii = begin_; ii < end_; ii += ugrid_size_) {
    mtl_k0004_advect_c4_0_0_func(root_addr, global_tmps_addr, ctx_addr, runtime_addr, print_assert_addr, ii);
  }
}
